...
namespace WebAPI.Core
{
    public class UploadMeterReadings
    {
        ...
        public UploadMeterReadings(IAccountService accountService, IMeterReadingService meterReadingService)
        {
        ...
        /// <summary>
        /// Process uploaded meter readings
        /// </summary>
        /// <param name="request"></param>
        /// <returns></returns>
        public async Task<UploadMeterReadingsResponse> ProcessUploadMeterReadings(UploadMeterReadingsRequest request)
        {
